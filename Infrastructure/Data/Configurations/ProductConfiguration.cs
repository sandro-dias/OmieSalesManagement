...
namespace Infrastructure.Data.Configurations
{
    public class ProductConfiguration : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.Property(x => x.UnitValue).HasColumnName("VALOR_UNITARIO").HasColumnType("DECIMAL(19,5)");
            builder.Property(x => x.TotalValue).HasColumnName("VALOR_TOTAL").HasColumnType("DECIMAL(19,5)");
        }
    }
}